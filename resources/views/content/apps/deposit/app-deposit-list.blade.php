...
<!-- deposits list start -->
<section class="app-deposit-list">
  ...
  <div class="card">
    ...
    <!-- Modal to add new deposit starts-->
    <div class="modal modal-slide-in new-deposit-modal fade" id="modals-slide-in">
      <div class="modal-dialog">
        <form class="add-new-deposit modal-content pt-0"  id="postForm" name="postForm" >
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">×</button>
          <div class="modal-header mb-1">
            <h5 class="modal-title" id="exampleModalLabel">Add New Deposit</h5>
          </div>
...
@section('page-script')
 ...
 <script src="{{ asset(mix('js/scripts/forms/pickers/form-pickers.js')) }}"></script>
  ...
  <script src="{{ asset(mix('js/scripts/pages/app-deposit-list.js')) }}"></script>
  }
@endsection
