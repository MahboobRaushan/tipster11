...
<!-- withdrawals list start -->
<section class="app-withdrawal-list">
  
  <!-- list and filter start -->
  <div class="card">
    
    <div class="card-datatable table-responsive pt-0">
      <table class="withdrawal-list-table table">
    ...
    <!-- Modal to add new withdrawal starts-->
    <div class="modal modal-slide-in new-withdrawal-modal fade" id="modals-slide-in">
      <div class="modal-dialog">
        <form class="add-new-withdrawal modal-content pt-0"  id="postForm" name="postForm" >
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">×</button>
          <div class="modal-header mb-1">
            <h5 class="modal-title" id="exampleModalLabel">Add New Withdrawal</h5>
          </div>
    ...
    <!-- Modal to add new withdrawal Ends-->
    

  </div>
  <!-- list and filter end -->
</section>
<!-- withdrawals list ends -->
@endsection
...
@section('page-script')
 ...
 <script src="{{ asset(mix('js/scripts/forms/pickers/form-pickers.js')) }}"></script>
  ...
  <script src="{{ asset(mix('js/scripts/pages/app-withdrawal-list.js')) }}"></script>
  }
@endsection
