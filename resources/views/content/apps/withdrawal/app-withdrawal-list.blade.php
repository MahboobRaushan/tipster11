  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Withdraw Details List</h4>
      </div>
      <div class="card-body">
        <div class="card-text">
          <div class="row">
      ...
      <div id="table_data">
      @include('/content/apps/withdrawal/app-withdrawal-list-data')
      </div>
    </div>
  </div>
</div>
...
<script src="{{ asset('js/scripts/pages/app_withdrawdetails_list.js') }}"></script>
