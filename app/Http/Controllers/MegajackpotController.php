...
class MegajackpotController extends Controller
{
    ...
    { 
        ...
        return view('/content/apps/megajackpots/app-megajackpots-list',['pageConfigs' => $pageConfigs,'custom_get_all_permissions_access'=>$custom_get_all_permissions_access]);
    }
}
