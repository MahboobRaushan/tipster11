...
Route::group(['middleware' => ['auth:sanctum', 'verified']], function () {
    Route::get('home', [DashboardController::class, 'dashboardEcommerce']);
...
Route::group(['middleware' => ['auth:sanctum', 'verified']], function () {
     Route::post('users/photoupdate', [UserController::class,'photoupdate'])->name('user.photoupdate');
    Route::get('users', [UserController::class,'index'])->name('users');
    Route::get('users/ajaxlist', [UserController::class,'ajaxlist']);
    Route::post('users/add', [UserController::class,'store'])->name('users.store');
    Route::post('users/{id}', [UserController::class,'details']);
    Route::post('userspermission/{id}', [UserController::class,'permissiondetails']);

    Route::get('users/photo', [UserController::class,'userphoto'])->name('user.photo');
    ...
    Route::put('users/permission', [UserController::class,'permission'])->name('users.permission');
    Route::delete('users/{id}',  [UserController::class,'destroy'])->name('users.destroy');

    Route::get('games', [GameController::class,'index'])->name('games');
    Route::get('games/ajaxlist', [GameController::class,'ajaxlist']);
    Route::post('games/add', [GameController::class,'store'])->name('games.store');
    Route::post('games/{id}', [GameController::class,'details']);
    Route::post('games/update/{id}', [GameController::class,'update'])->name('games.update');
    Route::delete('games/{id}',  [GameController::class,'destroy'])->name('games.destroy');


    Route::get('commission/direct', [CommissionController::class,'direct'])->name('direct');
    Route::get('commission/indirect', [CommissionController::class,'indirect'])->name('indirect');
